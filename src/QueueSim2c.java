public class QueueSim2c {

    static double totalTime = 10000000;  // 合計シミュレーション時間
    static double lambda,mu;  // 平均到着率，平均サービス時間
    ...
    public static void main (String args[]) {
    	...
    	mu = Double.valueOf(args[1]);

    	System.out.println("平均到着率: "+ lambda + "平均サービス時間: " + mu);

    	QueueSim2c qsim = new QueueSim2c();
        qsim.cal();
    }
}
